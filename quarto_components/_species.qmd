...
spSelectLab <- htmltools::div(
  "Search species", actionButton("filterSpecies", htmltools::HTML('<span><i class="bi bi-funnel"></i> Filter</span>'), style = "border: 0; font-size: 12px; margin-left: 10px; background: none;"), shiny::uiOutput("filterActive", inline = TRUE), style = "display: flex; flex-direction: row;"
)
